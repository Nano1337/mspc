...
# look at options/base_options and train_options for more parameters

name='gcpert_alpha_1.8_template' # CHANGE name
pert_threshold=1.8 ###scale of perturbation
lambda_blank=50.0  ###constraint coefficient of perturbation
identity=10.0
direction='AtoB'

dataroot='/home/public/clinicalColorAdapt_blueWLC' # CHANGE dataroot
batch_size=4 
load_size=144
...
--direction $direction --use_wandb --gpu_ids 2; # CHECK gpu_ids to see if enough memory