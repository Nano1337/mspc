...
name='gcpert_alpha_1.8_bluewlc' # CHANGE name
...
python test.py --name $name --dataroot $dataroot --model $model --eval \
...
--direction $direction --gpu_ids 1 # CHECK gpu_ids to see if enough memory